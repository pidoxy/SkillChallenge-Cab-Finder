        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          {error ? error : data.map((field, idx) =>
            <tr key={idx} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              >
                {field.destination_coord_lat}
              </th>
              <td class="px-6 py-4">{field.destination_coord_long}</td>
              <td class="px-6 py-4">{field.location_description}</td>
              <td class="px-6 py-4">{field.location_id}</td>
              <td class="px-6 py-4">{field.start_coord_lat}</td>
              <td class="px-6 py-4">{field.start_coord_long}</td>
            </tr>
)}
          </tbody>
        </table>
